/*   
  *  PacCarl is a recreation of of Pacman with our own implementation and UI
  *  Mustafa Ali & Debbie Lim
  *  Project 2(Final), 12/09/2022
  */
...
void draw() {
  ...
  //  }
  //}
  // Create an array of Images and iterate through them and get their x and y's (such methods exist?)
  // If current PacX and Y is close, we delete that image from the array or make it NULL
